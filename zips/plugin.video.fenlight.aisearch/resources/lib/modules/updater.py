...
default_repo_name = 'DutchTechTestRepo'
heading_str = 'fenlight.aisearch Updater'
error_str = 'Error'
notification_occuring_str = 'fenlight.aisearch Update Occuring'
notification_available_str = 'fenlight.aisearch Update Available'
notification_updating_str = 'fenlight.aisearch Performing Update'
notification_rollback_str = 'fenlight.aisearch Performing Rollback'
...
success_str = '[CR]Success.[CR]fenlight.aisearch updated to version [B]%s[/B]'
rollback_heading_str = 'Choose Rollback Version'
success_rollback_str = '[CR]Success.[CR]fenlight.aisearch rolled back to version [B]%s[/B]'
confirm_rollback_str = 'Are you sure?[CR]Version [B]%s[/B] will overwrite your current installed version.' \
						'[CR]fenlight.aisearch will set your update action to [B]OFF[/B] if rollback is successful'
...
no_changes_str = 'You are running the current version of fenlight.aisearch.[CR][CR]There is no new version changelog to view.'
